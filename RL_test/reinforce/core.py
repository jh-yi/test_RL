...
class Transition(object):
    #record current state s0, current action a0, reward , new state s1, is_done, +data<list>
...
class Experience(object):
    ...
    def __init__(self, capacity:int = 20000):
        #set capacity, episodes, next_id, total_trans
    ...
    def sample(self, batch_size=1): # sample transition
        '''get Transmition randomly from experience, return a <list>, consists of batch_size * Transition object
...
class Agent(object):
    ...
    def __init__(self, env: Env = None, 
        ...
        '''store info. that an agent can observe from environment(e.g. obs_space, action_space, cur_state) and experience
    ...
    def act(self, a0):
        '''get s1,r1,is_done,info from step, get total_reward from experience by adding a new transition
    ...
    def sample(self, batch_size = 64):
        '''随机取样
        '''
        return self.experience.sample(batch_size)# get Transmition randomly from experience, return a <list>, consists of batch_size * Transition object
